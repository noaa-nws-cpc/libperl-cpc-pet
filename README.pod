...
CPC::PET - Calculate potential evapotranspiration (PET) with methodologies used at the L<Climate Prediction Center (CPC)|https://www.cpc.ncep.noaa.gov>
...
Adam Allgood (Email: L<adam.allgood@noaa.gov|mailto:adam.allgood@noaa.gov>)
